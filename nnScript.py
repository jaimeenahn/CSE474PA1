...
def preprocess():
    ...
    ttrain_data = np.concatenate((mat['train0'][:(length0-1000),:], mat['train1'][:(length1-1000),:],
                                 mat['train2'][:(length2-1000),:], mat['train3'][:(length3-1000),:],
                                 mat['train4'][:(length4-1000),:], mat['train5'][:(length5-1000),:],
                                 mat['train6'][:(length6-1000),:], mat['train7'][:(length7-1000),:],
                                 mat['train8'][:(length8-1000),:], mat['train9'][:(length9-1000),:]), 0)
    train_label = np.concatenate((np.ones((mat['train0'][:(length0-1000),:].shape[0], 1), dtype='uint8'),
                                  2 * np.ones((mat['train1'][:(length1-1000),:].shape[0], 1), dtype='uint8'),
                                  3 * np.ones((mat['train2'][:(length2-1000),:].shape[0], 1), dtype='uint8'),
                                  4 * np.ones((mat['train3'][:(length3-1000),:].shape[0], 1), dtype='uint8'),
                                  5 * np.ones((mat['train4'][:(length4-1000),:].shape[0], 1), dtype='uint8'),
                                  6 * np.ones((mat['train5'][:(length5-1000),:].shape[0], 1), dtype='uint8'),
                                  7 * np.ones((mat['train6'][:(length6-1000),:].shape[0], 1), dtype='uint8'),
                                  8 * np.ones((mat['train7'][:(length7-1000),:].shape[0], 1), dtype='uint8'),
                                  9 * np.ones((mat['train8'][:(length8-1000),:].shape[0], 1), dtype='uint8'),
                                  10 * np.ones((mat['train9'][:(length9-1000),:].shape[0], 1), dtype='uint8')), 0)
    ...
    tvalidation_data = np.concatenate((mat['train0'][(length0-1000):,:], mat['train1'][(length1-1000):,:],
                                 mat['train2'][(length2-1000):,:], mat['train3'][(length3-1000):,:],
                                 mat['train4'][(length4-1000):,:], mat['train5'][(length5-1000):,:],
                                 mat['train6'][(length6-1000):,:], mat['train7'][(length7-1000):,:],
                                 mat['train8'][(length8-1000):,:], mat['train9'][(length9-1000):,:]), 0)
    validation_label = np.concatenate((np.ones((1000,1), dtype='uint8'),
                                 2 * np.ones((1000,1), dtype='uint8'),
                                 3 * np.ones((1000,1), dtype='uint8'),
                                 4 * np.ones((1000,1), dtype='uint8'),
                                 5 * np.ones((1000,1), dtype='uint8'),
                                 6 * np.ones((1000,1), dtype='uint8'),
                                 7 * np.ones((1000,1), dtype='uint8'),
                                 8 * np.ones((1000,1), dtype='uint8'),
                                 9 * np.ones((1000,1), dtype='uint8'),
                                 10 * np.ones((1000,1), dtype='uint8')), 0)
